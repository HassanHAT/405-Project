...
const Quiz = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      const response = await fetch(`https://quizapi.io/api/v1/questions?apiKey=D6l7KeNo9XeyqigwwTymuhRGcZt9jscJo0xsMWqV&difficulty=${difficulty}&category=${category}&limit=${limit}`
      );
